...
{ 
    ...
    int n = 1, r = 1;
    int a = 1, b = 1;
	cout << "Indique la cantidad de movimientos abajo: " << endl;
	cin >> a;
	cout << "indique la cantidad de movimiento izquierda: " << endl;
	cin >> b;
    ...
    cout << "Cantidad de caminos: "<< nCr(n, r)<<endl;
	cout << "Corresponde a un tablero de " <<  (2*a)+1<<"X"<<(3*b)+1<<endl;
	...
	char str[combinatorics.length()]; 
  
    int i; 
    for (i = 0; i < sizeof(combinatorics); i++) { 
        str[i] = combinatorics[i]; 
      } 
	
 cout << "Lo caminos codificados como sucesiones donde 0 significa 2 movimientos hacia abajo y 1 signiifca 3 movimientos a la izquierda"<<endl;
